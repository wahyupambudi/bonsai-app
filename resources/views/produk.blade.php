...
<section id="produk" class="new-arrivals">
    <div class="container">
        ...
        <div class="new-arrivals-content">
            <div class="row">
                <?php
						$sql = "select * from t_artikel order by RAND() LIMIT 8";
                        ...
                        <div class="single-new-arrival-bg">
                            ...
                            <div class="new-arrival-cart">
                                <p>
                                    ...
                                    <a href="../detail?id=<?= $data['id']; ?>">Detail Produk <?= $data["judul"]; ?></a>
                                </p>
                            </div>
                        </div>
                        <h4><a href="../detail?id=<?= $data['id']; ?>"><?= $data["judul"]; ?></a></h4>
                ...
                <?php
					...
					?>
                <div align="center">
                    <button style="width:50%" class="btn-cart welcome-add-cart" onclick="window.location.href='/produk'">
                        <span class="lnr lnr-store"></span>
                        Lihat Semua Produk Bonsai
